...
fn main() {
    ...
    let path = Path::new("./market.cairo");
    ...
    let entry_point = contract.entry_points_by_type.external.get(8).unwrap();
    ...
    let address: Vec<u8> = hex::decode("49d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc70").unwrap();
    let address_f: Felt = Felt::from_bytes_be_slice(&address[..]);
    let amount = 13123460341667945_u128;
    let result = native_executor
        .invoke_contract_dynamic(fn_id,&[Felt::MAX, Felt::ONE/*address_f, amount.into()*/], Some(u128::MAX), SyscallHandler::new())
